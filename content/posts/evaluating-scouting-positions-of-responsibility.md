...
Positions need not ﬂow from one to the other; there may be gaps between them.

Standards are equally clear and, no surprise, highly individual 4.2.3.4.3 Meeting Unit Expectations. If a unit has established expectations for positions of responsibility, and if, within reason based on his personal skill set, the Scout meets them, he fulﬁlls the requirement. When a Scout assumes a position, something related to the desired results must happen. It is a disservice to the Scout and to the unit to reward work that has not been done.
